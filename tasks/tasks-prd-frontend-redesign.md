...
- [x] 3.0 Stakeholder-Seite neu gestalten
...
- [x] 5.0 Reporting-Seite neu gestalten
...
- [x] 6.0 Backend-Endpoints implementieren
  ...
  - [x] 6.8 Security Config aktualisieren: Alle neuen Endpoints rollenbasiert schützen
